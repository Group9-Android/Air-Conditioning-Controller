...
public class Profile_p extends Activity implements View.OnClickListener{
        ...
        confirmbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (pd1 && pd2){
                    ...
                    RadioButton b = Profile_p.this.findViewById(selected);

                    String text = spinner1.getSelectedItem().toString() + "  " + spinner2.getSelectedItem().toString()+"  "+b.getText().toString();
                    Toast.makeText(Profile_p.this, text, Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(Profile_p.this, "Please input the Date and Time.", Toast.LENGTH_SHORT).show();
                }
            }
        });
